...
urlpatterns = [
    ...
    path('cron-api/unread-messages/', api.gmail_get_unread_messages, name="gmail_get_unread_messages"),
    path('cron-api/notify-users-open-messages/', api.notify_users_of_open_messages, name="notify_users_of_open_messages"),
    path('gmail-api/gmail-oauth-callback/', admin_v.GmailOAuthCallback.as_view()),
