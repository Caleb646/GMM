...
urlpatterns = [
    ...
    path('message-log/<slug:slug>/detailed/', v.DashboardView.as_view(), name="dashboard_detailed"),
    path('message-log/<slug:slug>/resend/', v.resend_dashboard_link, name="dashboard_resend"),
